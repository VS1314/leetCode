...
public class Easy_13 {
	...
	public static int romanToInt(String s) {
		...
		for (int i = s.length() - 1; i >= 0; i--) {
			...
			// subtract it
			if (i < s.length() - 1 && symbolToValue.get(currentSymbol) < symbolToValue.get(s.charAt(i + 1))) {
				result -= symbolToValue.get(currentSymbol);
			} else {
	...
	public static void main(String[] args) {
		String s = "MCMXCIV";
		System.out.println(Easy_13.romanToInt(s));
	}
